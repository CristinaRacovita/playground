...
<div class="flex justify-center h-[100vh]">
    ...
    <div class="dark:text-white flex flex-col self-center">
        ...
        <button @click="scrollToAboutMePage()" class="bg-sky-blue dark:bg-transparent dark:hover:bg-coral hover:opacity-80 dark:text-white dark:border dark:border-white hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center w-fit mt-3"> Explore
